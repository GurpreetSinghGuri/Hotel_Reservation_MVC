...
Update-Database -Context Hotel_Reservation_MVCIdentityContext



5. On the console execute the following command

Update-Database -Context Hotel_Reservation_MVCDataContext



6. After migration is successful Run the project 

7 if you click on Clients/Hotels and etc (Except Home) this will redirect you to ASP .net identity login page login from the following credentials

User : admin@hotels.com
Password: 1qaz2wsX@
